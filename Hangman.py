...
def generate_word_string(word, letters_guessed):
    """
    This function generates the word display that 
    shows which letters the user has guessed correctly
    """
    output = []
    for letter in word:
...
if __name__ == '__main__':
    ...
    #loop repeats the guessing sequence until the guesses all the letters or until the user runs out of guesses
...
num_guesses < 6):
    ...
    #tell the user they have lost or won 
    if num_guesses < 6:
